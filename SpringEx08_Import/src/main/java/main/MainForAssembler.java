...
import SpringEx08_Import.DuplicateMemberException;
import SpringEx08_Import.MemberInfoPrinter;
import SpringEx08_Import.MemberListPrinter;
import SpringEx08_Import.MemberNotFoundException;
import SpringEx08_Import.MemberRegisterService;
import SpringEx08_Import.RegisterRequest;
import SpringEx08_Import.WrongIdPasswordException;
import config.AppContext1;
import config.AppContext2;
import config.AppContextImport;
...
public class MainForAssembler {
	...
	public static void main(String[] args) throws IOException{
		...
		ctx = new AnnotationConfigApplicationContext(AppContextImport.class);
